...
class AddForeignKeysToAkTranSactionTable extends Migration {
	...
	public function up()
	{
		Schema::table('ak_tran_saction', function(Blueprint $table)
		{
			...
			$table->foreign('ak_tran_saction_schedule', 'fk_ak_tran_saction_ak_schedule1')->references('ak_course_schedule_id')->on('ak_course_schedule')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('ak_tran_saction', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_ak_tran_saction_ak_schedule1');
